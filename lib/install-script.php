...
if (!is_user_logged_in()) {
   ...
   if (!current_user_can("manage_options")) {
      ...
      /*
        Class Name: dbHelper_install_script_photo_gallery_plus
        Parameter: No
       ...
       */
      class dbHelper_install_script_photo_gallery_plus {
         /*
      ...
      function get_parent_id_photo_gallery_plus($type) {
         ...
         $parent_id = $wpdb->get_var
             ...
             $wpdb->prepare
                 (
                 "SELECT id FROM " . photo_gallery_plus() . " WHERE " . photo_gallery_plus() . ". type = %s", $type
             )
         );
         return $parent_id;
      }
      ...
      /*
        Function Name: table_photo_gallery_plus
        Parameter: No
        Description: It is used for creating a parent table.
        Created On: 01-06-2017 09:00
        Created By: The WP Geeks Team
       */
      function table_photo_gallery_plus() {
         global $wpdb;
         $obj_dbHelper_photo_gallery_plus_parent = new dbHelper_install_script_photo_gallery_plus();
         $sql = "CREATE TABLE IF NOT EXISTS " . photo_gallery_plus() . "
                            (
         ...
         $data = "INSERT INTO " . photo_gallery_plus() . " (`type`, `parent_id`) VALUES
                            ('galleries', 0),
                            ('albums',0),
                            ('tags', 0),
                            ('layout_settings', 0),
      ...
      /*
        Function Name: table_photo_gallery_plus_meta
        Parameter: No
        Description: It is used for creating a meta table.
        Created On: 01-06-2017 09:00
        Created By: The WP Geeks Team
       */
      function table_photo_gallery_plus_meta() {
         global $wpdb;
         $obj_dbHelper_photo_gallery_plus_meta_table = new dbHelper_install_script_photo_gallery_plus();
         $sql = "CREATE TABLE IF NOT EXISTS " . photo_gallery_plus_meta() . "
				(
         ...
         $parent_table_data = $wpdb->get_results
             (
             "SELECT id,type FROM " . photo_gallery_plus()
         );
         ...
         foreach ($parent_table_data as $row) {
            switch ($row->type) {
               case "layout_settings":
                  ...
                  $obj_dbHelper_photo_gallery_plus_meta_table->insertCommand(photo_gallery_plus_meta(), $thumbnail_layout_data_serialize);
                  ...
                  $obj_dbHelper_photo_gallery_plus_meta_table->insertCommand(photo_gallery_plus_meta(), $masonry_layout_data_serialize);
                  ...
                  $obj_dbHelper_photo_gallery_plus_meta_table->insertCommand(photo_gallery_plus_meta(), $slideshow_layout_data_serialize);
                  ...
                  $image_browser_layout_data["image_browser_layout_general_background_color"] = "#ebe8eb";
                  ...
                  $obj_dbHelper_photo_gallery_plus_meta_table->insertCommand(photo_gallery_plus_meta(), $image_browser_layout_data_serialize);
                  ...
                  $obj_dbHelper_photo_gallery_plus_meta_table->insertCommand(photo_gallery_plus_meta(), $justified_grid_layout_data_serialize);
                  ...
                  $obj_dbHelper_photo_gallery_plus_meta_table->insertCommand(photo_gallery_plus_meta(), $blog_style_layout_data_serialize);
                  ...
                  $compact_album_layout_data["compact_album_layout_gallery_description_padding"] = "5,10,10,5";
                  ...
                  $obj_dbHelper_photo_gallery_plus_meta_table->insertCommand(photo_gallery_plus_meta(), $compact_album_data_serialize);
                  ...
                  $extended_album_layout_data["extended_album_layout_gallery_description_padding"] = "5,10,10,5";
                  ...
                  $obj_dbHelper_photo_gallery_plus_meta_table->insertCommand(photo_gallery_plus_meta(), $extended_album_data_serialize);
                  ...
                  $obj_dbHelper_photo_gallery_plus_meta_table->insertCommand(photo_gallery_plus_meta(), $custom_css_data_serialize);
                  break;
               ...
               case "lightboxes_settings":
                  ...
                  $obj_dbHelper_photo_gallery_plus_meta_table->insertCommand(photo_gallery_plus_meta(), $fancy_box_data_serialize);
                  ...
                  $obj_dbHelper_photo_gallery_plus_meta_table->insertCommand(photo_gallery_plus_meta(), $color_box_setting_serialize);
                  ...
                  $obj_dbHelper_photo_gallery_plus_meta_table->insertCommand(photo_gallery_plus_meta(), $foo_box_settings_serialize);
                  ...
                  $obj_dbHelper_photo_gallery_plus_meta_table->insertCommand(photo_gallery_plus_meta(), $nivo_lightbox_serialize);
                  ...
                  $obj_dbHelper_photo_gallery_plus_meta_table->insertCommand(photo_gallery_plus_meta(), $lightcase_settings_serialize);
                  break;
               ...
               case "general_settings":
                  ...
                  $obj_dbHelper_photo_gallery_plus_meta_table->insertCommand(photo_gallery_plus_meta(), $global_options_serialize);
                  ...
                  $obj_dbHelper_photo_gallery_plus_meta_table->insertCommand(photo_gallery_plus_meta(), $lazyload_settings_serialize);
                  ...
                  $obj_dbHelper_photo_gallery_plus_meta_table->insertCommand(photo_gallery_plus_meta(), $searchbox_settings_serialize);
                  ...
                  $obj_dbHelper_photo_gallery_plus_meta_table->insertCommand(photo_gallery_plus_meta(), $orderby_settings_serialize);
                  ...
                  $obj_dbHelper_photo_gallery_plus_meta_table->insertCommand(photo_gallery_plus_meta(), $filter_settings_serialize);
                  ...
                  $obj_dbHelper_photo_gallery_plus_meta_table->insertCommand(photo_gallery_plus_meta(), $page_navigation_serialize);
                  ...
                  $obj_dbHelper_photo_gallery_plus_meta_table->insertCommand(photo_gallery_plus_meta(), $watermark_settings_serialize);
                  ...
                  $obj_dbHelper_photo_gallery_plus_meta_table->insertCommand(photo_gallery_plus_meta(), $advertisement_serialize);
                  break;

               case "roles_and_capabilities_settings":
                  $roles_data = array();
                  $roles_data["roles_and_capabilities"] = "1,1,1,0,0,0";
                  $roles_data["show_photo_gallery_plus_top_bar_menu"] = "enable";
                  ...
                  $obj_dbHelper_photo_gallery_plus_meta_table->insertCommand(photo_gallery_plus_meta(), $roles_data_serialize);
                  break;
               ...
               case "other_settings":
                  ...
                  $obj_dbHelper_photo_gallery_plus_meta_table->insertCommand(photo_gallery_plus_meta(), $other_settings_serialize);
                  break;
            }
         }
      }
      switch ($photo_gallery_plus_version_number) {
         case "":
            table_photo_gallery_plus();
            table_photo_gallery_plus_meta();
            ...
            $count_gallery = $wpdb->get_var
                ...
                $wpdb->prepare
                    (
                    "SELECT count(id) FROM " . photo_gallery_plus() . " WHERE " . photo_gallery_plus() . ". type = %s", "gallery"
                )
            );
            if ($count_gallery == 0) {
               $obj_dbHelper_photo_gallery_plus = new dbHelper_install_script_photo_gallery_plus();
               ...
               for ($flag = 0; $flag < count($images); $flag++) {
                  ...
                  $src_file = PHOTO_GALLERY_PLUS_PLUGIN_DIR_URL . "/assets/admin/images/" . $image_name;
                  copy($src_file, PHOTO_GALLERY_PLUS_ORIGINAL_DIR . $fileName);
                  copy($src_file, PHOTO_GALLERY_PLUS_UPLOAD_DIR . $fileName);

                  $thumbnail_image_name = $obj_dbHelper_photo_gallery_plus->createThumbs_photo_gallery_plus($image_name, $image_data);
                  $image_exif_detail = $obj_dbHelper_photo_gallery_plus->file_exif_information_photo_gallery_plus(PHOTO_GALLERY_PLUS_UPLOAD_DIR . $image_name, "FILE");
      ...
      update_option("photo-gallery-plus-version-number", "1.0");
   }
}