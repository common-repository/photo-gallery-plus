<?php
/**
 * Template to view and update the settings for Masonry Layout.
 *
 * @author 	The WP Geeks
...
if (!is_user_logged_in()) {
   ...
   if (!$access_granted) {
      ...
      $masonry_background_color_and_transperancy = isset($manage_masonry_data["masonry_layout_general_background_color_transparency"]) ? explode(",", esc_attr($manage_masonry_data["masonry_layout_general_background_color_transparency"])) : array("#ebe8eb", 100);
      $masonry_layout_general_margin = isset($manage_masonry_data["masonry_layout_general_margin"]) ? explode(",", esc_attr($manage_masonry_data["masonry_layout_general_margin"])) : array(10, 10, 0, 0);
      $masonry_layout_general_padding = isset($manage_masonry_data["masonry_layout_general_padding"]) ? explode(",", esc_attr($manage_masonry_data["masonry_layout_general_padding"])) : array(0, 0, 0, 0);
      $masonry_layout_general_border_style = isset($manage_masonry_data["masonry_layout_general_border_style"]) ? explode(",", esc_attr($manage_masonry_data["masonry_layout_general_border_style"])) : array(0, "solid", "#cccccc");
      $masonry_layout_general_shadow = isset($manage_masonry_data["masonry_layout_general_shadow"]) ? explode(",", esc_attr($manage_masonry_data["masonry_layout_general_shadow"])) : array(0, 0, 0, 0);
      $masonry_layout_general_hover_effect_value = isset($manage_masonry_data["masonry_layout_general_hover_effect_value"]) ? explode(",", esc_attr($manage_masonry_data["masonry_layout_general_hover_effect_value"])) : array("none", 0, 0, 0);
      $masonry_layout_gallery_title_font_style = isset($manage_masonry_data["masonry_layout_gallery_title_font_style"]) ? explode(",", esc_attr($manage_masonry_data["masonry_layout_gallery_title_font_style"])) : array(24, "#000000");
      $masonry_layout_gallery_title_margin = isset($manage_masonry_data["masonry_layout_gallery_title_margin"]) ? explode(",", esc_attr($manage_masonry_data["masonry_layout_gallery_title_margin"])) : array(10, 0, 10, 0);
      $masonry_layout_gallery_title_padding = isset($manage_masonry_data["masonry_layout_gallery_title_padding"]) ? explode(",", esc_attr($manage_masonry_data["masonry_layout_gallery_title_padding"])) : array(10, 0, 10, 0);
      $masonry_layout_gallery_description_font_style = isset($manage_masonry_data["masonry_layout_gallery_description_font_style"]) ? explode(",", esc_attr($manage_masonry_data["masonry_layout_gallery_description_font_style"])) : array(18, "#000000");
      $masonry_layout_gallery_description_margin = isset($manage_masonry_data["masonry_layout_gallery_description_margin"]) ? explode(",", esc_attr($manage_masonry_data["masonry_layout_gallery_description_margin"])) : array(10, 0, 10, 0);
      $masonry_layout_gallery_description_padding = isset($manage_masonry_data["masonry_layout_gallery_description_padding"]) ? explode(",", esc_attr($manage_masonry_data["masonry_layout_gallery_description_padding"])) : array(0, 0, 10, 0);
      $masonry_layout_thumbnail_title_font_style = isset($manage_masonry_data["masonry_layout_thumbnail_title_font_style"]) ? explode(",", esc_attr($manage_masonry_data["masonry_layout_thumbnail_title_font_style"])) : array(16, "#000000");
      $masonry_layout_thumbnail_title_margin = isset($manage_masonry_data["masonry_layout_thumbnail_title_margin"]) ? explode(",", esc_attr($manage_masonry_data["masonry_layout_thumbnail_title_margin"])) : array(0, 5, 0, 5);
      $masonry_layout_thumbnail_title_padding = isset($manage_masonry_data["masonry_layout_thumbnail_title_padding"]) ? explode(",", esc_attr($manage_masonry_data["masonry_layout_thumbnail_title_padding"])) : array(10, 10, 10, 10);
      $masonry_layout_thumbnail_description_font_style = isset($manage_masonry_data["masonry_layout_thumbnail_description_font_style"]) ? explode(",", esc_attr($manage_masonry_data["masonry_layout_thumbnail_description_font_style"])) : array(16, "#777");
      $masonry_layout_thumbnail_description_margin = isset($manage_masonry_data["masonry_layout_thumbnail_description_margin"]) ? explode(",", esc_attr($manage_masonry_data["masonry_layout_thumbnail_description_margin"])) : array(0, 5, 0, 5);
      $masonry_layout_thumbnail_description_padding = isset($manage_masonry_data["masonry_layout_thumbnail_description_padding"]) ? explode(",", esc_attr($manage_masonry_data["masonry_layout_thumbnail_description_padding"])) : array(5, 10, 10, 5);
                     ...
                     <div class="form-body">
                        ...
                        <div class="tabbable-custom">
                           <ul class="nav nav-tabs ">
                              ...
                              <li>
                                 <a aria-expanded="false" href="#title" data-toggle="tab">
                                    <?php echo $pgp_thumbnail_title; ?>
                                 </a>
                              </li>
                              <li>
                                 <a aria-expanded="false" href="#description" data-toggle="tab">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <div class="input-icon right">
                                             <input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_background_color_and_transperancy[]" id="ux_txt_background_color" placeholder="<?php echo $pgp_background_color; ?>" onfocus="color_picker_photo_gallery_plus(this, this.value)"  value="<?php echo esc_attr($masonry_background_color_and_transperancy[0]); ?>">
                                             <input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_background_color_and_transperancy[]" id="ux_txt_background_transperancy" maxlength="3" placeholder="<?php echo $pgp_background_transparency; ?>" onkeypress="only_digits_photo_gallery_plus(event);" onfocus="paste_prevent_photo_gallery_plus(this.id);" onchange="check_opacity_photo_gallery_plus(this);" onblur="default_value_photo_gallery_plus('#ux_txt_background_transperancy', 50);" value="<?php echo intval($masonry_background_color_and_transperancy[1]); ?>">
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                                    ...
                                    <div class="col-md-12">
                                       <div class="form-group">
                                          <label class="control-label">
                                             ...
                                             <i class="icon-custom-question tooltips" data-original-title="<?php echo $pgp_masonry_layout_opacity_tooltip; ?>" data-placement="right"></i>
                                             <span class="required" aria-required="true">* <?php echo " ( " . $pgp_premium_edition . " ) "; ?></span>
                                          </label>
                                          <div class="input-icon right">
                                             <input type="text" class="form-control" name="ux_txt_opacity" id="ux_txt_opacity" placeholder="<?php echo $pgp_opacity_placeholder; ?>" onblur="default_value_photo_gallery_plus('#ux_txt_opacity', 100);" maxlength="3" onkeypress="only_digits_photo_gallery_plus(event);" onfocus="paste_prevent_photo_gallery_plus(this.id);" onchange="check_opacity_photo_gallery_plus(this);" value="<?php echo isset($manage_masonry_data["masonry_layout_general_masonry_opacity"]) ? intval($manage_masonry_data["masonry_layout_general_masonry_opacity"]) : 100; ?>">
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          <label class="control-label">
                                             ...
                                             <i class="icon-custom-question tooltips" data-original-title="<?php echo $pgp_masonry_layout_border_style_tooltip; ?>" data-placement="right"></i>
                                             <span class="required" aria-required="true">* <?php echo " ( " . $pgp_premium_edition . " ) "; ?></span>
                                          </label>
                                          <div class="input-icon right">
                                             <input type="text" class="form-control input-width-25 input-inline" name="ux_txt_border_style[]" id="ux_txt_border_style_width" placeholder="<?php echo $pgp_width_placeholder; ?>" onblur="default_value_photo_gallery_plus('#ux_txt_border_style_width', '0');" value="<?php echo intval($masonry_layout_general_border_style[0]); ?>">
                                             ...
                                             <input type="text" class="form-control input-normal input-inline" name="ux_txt_border_style[]" id="ux_txt_border_style_color" onfocus="color_picker_photo_gallery_plus(this, this.value)" onblur="default_value_photo_gallery_plus('#ux_txt_border_style_color', '#cccccc');" placeholder="<?php echo $pgp_color_placeholder; ?>" value="<?php echo esc_attr($masonry_layout_general_border_style[2]); ?>">
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          <label class="control-label">
                                             ...
                                             <i class="icon-custom-question tooltips" data-original-title="<?php echo $pgp_masonry_layout_border_radius_tooltip; ?>" data-placement="right"></i>
                                             <span class="required" aria-required="true">* <?php echo " ( " . $pgp_premium_edition . " ) "; ?></span>
                                          </label>
                                          <div class="input-icon right">
                                             <input type="text" class="form-control" name="ux_txt_border_radius" id="ux_txt_border_radius" placeholder="<?php echo $pgp_border_radius_placeholder; ?>"  maxlength="3" onblur="default_value_photo_gallery_plus('#ux_txt_border_radius', 0)" onkeypress="only_digits_photo_gallery_plus(event);" onfocus="paste_prevent_photo_gallery_plus(this.id);" value="<?php echo isset($manage_masonry_data["masonry_layout_general_border_radius"]) ? intval($manage_masonry_data["masonry_layout_general_border_radius"]) : 0; ?>">
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <div class="input-icon right">
                                             <input type="text" class="form-control" name="ux_txt_transition_time" id="ux_txt_transition_time" placeholder="<?php echo $pgp_transition_time_placeholder; ?>" onblur="default_value_photo_gallery_plus('#ux_txt_transition_time', 1)" maxlength="1" onkeypress="digits_with_dot_photo_gallery_plus(event);" onfocus="paste_prevent_photo_gallery_plus(this.id);" value="<?php echo isset($manage_masonry_data["masonry_layout_general_transition_time"]) ? intval($manage_masonry_data["masonry_layout_general_transition_time"]) : 1; ?>">
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          <label class="control-label">
                                             ...
                                             <i class="icon-custom-question tooltips" data-original-title="<?php echo $pgp_masonry_layout_margin_tooltip; ?>" data-placement="right"></i>
                                             <span class="required" aria-required="true">* <?php echo " ( " . $pgp_premium_edition . " ) "; ?></span>
                                          </label>
                                          <div class="input-icon right">
                                             <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_masonry_margin_text[]" id="ux_txt_masonry_margin_top_text" placeholder="<?php echo $pgp_top; ?>" maxlength="3" onkeypress="only_digits_photo_gallery_plus(event);" onfocus="paste_prevent_photo_gallery_plus(this.id);" onblur="default_value_photo_gallery_plus('#ux_txt_masonry_margin_top_text', 10);" value="<?php echo intval($masonry_layout_general_margin[0]); ?>">
                                             <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_masonry_margin_text[]" id="ux_txt_masonry_margin_right_text" placeholder="<?php echo $pgp_right; ?>" maxlength="3" onkeypress="only_digits_photo_gallery_plus(event);" onfocus="paste_prevent_photo_gallery_plus(this.id);" onblur="default_value_photo_gallery_plus('#ux_txt_masonry_margin_right_text', 10);" value="<?php echo intval($masonry_layout_general_margin[1]); ?>" >
                                             <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_masonry_margin_text[]" id="ux_txt_masonry_margin_bottom_text" placeholder="<?php echo $pgp_bottom; ?>" onblur="default_value_photo_gallery_plus('#ux_txt_masonry_margin_bottom_text', 0);" maxlength="3" onkeypress="only_digits_photo_gallery_plus(event);" onfocus="paste_prevent_photo_gallery_plus(this.id);" value="<?php echo intval($masonry_layout_general_margin[2]); ?>" >
                                             <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_masonry_margin_text[]" id="ux_txt_masonry_margin_left_text" placeholder="<?php echo $pgp_left; ?>" onblur="default_value_photo_gallery_plus('#ux_txt_masonry_margin_left_text', 0);" maxlength="3" onkeypress="only_digits_photo_gallery_plus(event);" onfocus="paste_prevent_photo_gallery_plus(this.id);" value="<?php echo intval($masonry_layout_general_margin[3]); ?>">
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          <label class="control-label">
                                             ...
                                             <i class="icon-custom-question tooltips" data-original-title="<?php echo $pgp_masonry_layout_padding_tooltip; ?>" data-placement="right"></i>
                                             <span class="required" aria-required="true">* <?php echo " ( " . $pgp_premium_edition . " ) "; ?></span>
                                          </label>
                                          <div class="input-icon right">
                                             <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_masonry_padding_text[]" id="ux_txt_masonry_padding_top_text" placeholder="<?php echo $pgp_top; ?>" onblur="default_value_photo_gallery_plus('#ux_txt_masonry_padding_top_text', 0);" maxlength="3" onkeypress="only_digits_photo_gallery_plus(event);" onfocus="paste_prevent_photo_gallery_plus(this.id);" value="<?php echo intval($masonry_layout_general_padding[0]); ?>">
                                             <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_masonry_padding_text[]" id="ux_txt_masonry_padding_right_text" placeholder="<?php echo $pgp_right; ?>" onblur="default_value_photo_gallery_plus('#ux_txt_masonry_padding_right_text', 0);" maxlength="3" onkeypress="only_digits_photo_gallery_plus(event);" onfocus="paste_prevent_photo_gallery_plus(this.id);" value="<?php echo intval($masonry_layout_general_padding[1]); ?>">
                                             <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_masonry_padding_text[]" id="ux_txt_masonry_padding_bottom_text" placeholder="<?php echo $pgp_bottom; ?>" onblur="default_value_photo_gallery_plus('#ux_txt_masonry_padding_bottom_text', 0);" maxlength="3" onkeypress="only_digits_photo_gallery_plus(event);" onfocus="paste_prevent_photo_gallery_plus(this.id);" value="<?php echo intval($masonry_layout_general_padding[2]); ?>">
                                             <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_masonry_padding_text[]" id="ux_txt_masonry_padding_left_text" placeholder="<?php echo $pgp_left; ?>" onblur="default_value_photo_gallery_plus('#ux_txt_masonry_padding_left_text', 0);" maxlength="3" onkeypress="only_digits_photo_gallery_plus(event);" onfocus="paste_prevent_photo_gallery_plus(this.id);" value="<?php echo intval($masonry_layout_general_padding[3]); ?>">
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="row">
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <div class="input-icon right">
                                             <input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_description_font[]" id="ux_txt_description_font_size" placeholder="<?php echo $pgp_font_size_placeholder; ?>" onblur="default_value_photo_gallery_plus('#ux_txt_description_font_size', 12);" maxlength="3" onkeypress="only_digits_photo_gallery_plus(event);" onfocus="paste_prevent_photo_gallery_plus(this.id);" value="<?php echo intval($masonry_layout_thumbnail_description_font_style[0]); ?>">
                                             <input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_description_font[]" id="ux_txt_description_font_color" onblur="default_value_photo_gallery_plus('#ux_txt_description_font_color', '#787D85');" onfocus="color_picker_photo_gallery_plus(this, this.value)"  placeholder="<?php echo $pgp_color_placeholder; ?>" value="<?php echo esc_attr($masonry_layout_thumbnail_description_font_style[1]); ?>">
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <div class="input-icon right">
                                             ...
                                             <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_description_padding[]" id="ux_txt_description_padding_bottom" placeholder="<?php echo $pgp_bottom; ?>" onblur="default_value_photo_gallery_plus('#ux_txt_description_padding_bottom', 10);" maxlength="3" onkeypress="only_digits_photo_gallery_plus(event);" onfocus="paste_prevent_photo_gallery_plus(this.id);" value="<?php echo intval($masonry_layout_thumbnail_description_padding[2]); ?>">
                                             <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_description_padding[]" id="ux_txt_description_padding_left" placeholder="<?php echo $pgp_left; ?>" onblur="default_value_photo_gallery_plus('#ux_txt_description_padding_left', 5);" maxlength="3" onkeypress="only_digits_photo_gallery_plus(event);" onfocus="paste_prevent_photo_gallery_plus(this.id);" value="<?php echo intval($masonry_layout_thumbnail_description_padding[3]); ?>">
                                          </div>
                                       </div>
                                    </div>
                                 </div>
