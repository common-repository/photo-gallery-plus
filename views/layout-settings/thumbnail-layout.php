...
if (!is_user_logged_in()) {
   ...
   if (!$access_granted) {
      ...
      $thumbnail_layout_general_border_style = isset($manage_thumbnail_data["thumbnail_layout_general_border_style"]) ? explode(",", esc_attr($manage_thumbnail_data["thumbnail_layout_general_border_style"])) : array(0, "none", "#000000");
      ...
      $thumbnail_layout_thumbnail_dimensions = isset($manage_thumbnail_data["thumbnail_layout_thumbnail_dimensions"]) ? explode(",", esc_attr($manage_thumbnail_data["thumbnail_layout_thumbnail_dimensions"])) : array(200, 150);
      if (isset($manage_thumbnail_data["thumbnail_layout_general_background_color_transparency"]) && $manage_thumbnail_data["thumbnail_layout_general_background_color_transparency"] != "") {
         ...
         $thumbnail_layout_general_background_color_transparency = isset($manage_thumbnail_data["thumbnail_layout_general_background_color_transparency"]) ? explode(",", esc_attr($manage_thumbnail_data["thumbnail_layout_general_background_color_transparency"])) : array("#ebe8eb", 50);
      }
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <div class="input-icon right">
                                             <input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_background_color_transperancy[]" id="ux_txt_background_color" placeholder="<?php echo $pgp_background_color; ?>" onfocus="color_picker_photo_gallery_plus(this, this.value)" value="<?php echo esc_attr($thumbnail_layout_general_background_color_transparency[0]); ?>">
                                             <input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_background_color_transperancy[]" id="ux_txt_background_transperancy" maxlength="3" placeholder="<?php echo $pgp_background_transparency; ?>"  onblur="default_value_photo_gallery_plus('#ux_txt_background_transperancy', 50);" onkeypress="only_digits_photo_gallery_plus(event);" onfocus="paste_prevent_photo_gallery_plus(this.id);" onchange="check_opacity_photo_gallery_plus(this);" value="<?php echo intval($thumbnail_layout_general_background_color_transparency[1]); ?>">
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <div class="input-icon right">
                                             <input type="text" class="form-control" name="ux_txt_border_radius" id="ux_txt_border_radius" placeholder="<?php echo $pgp_border_radius_placeholder; ?>" maxlength="3" onkeypress="only_digits_photo_gallery_plus(event);" onblur="default_value_photo_gallery_plus('#ux_txt_border_radius', 0)" onfocus="paste_prevent_photo_gallery_plus(this.id);" value="<?php echo isset($manage_thumbnail_data["thumbnail_layout_general_border_radius"]) ? intval($manage_thumbnail_data["thumbnail_layout_general_border_radius"]) : 0; ?>">
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <div class="input-icon right">
                                             <input type="text" class="form-control" name="ux_txt_transition_time" id="ux_txt_transition_time" placeholder="<?php echo $pgp_transition_time_placeholder; ?>" onblur="default_value_photo_gallery_plus('#ux_txt_transition_time', 1)" maxlength="1" onkeypress="digits_with_dot_photo_gallery_plus(event);" onfocus="paste_prevent_photo_gallery_plus(this.id);" value="<?php echo isset($manage_thumbnail_data["thumbnail_layout_general_transition_time"]) ? intval($manage_thumbnail_data["thumbnail_layout_general_transition_time"]) : 1; ?>">
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <div class="input-icon right">
                                             <input type="text" class="form-control" name="ux_txt_thumbnail_title_line_height" id="ux_txt_thumbnail_title_line_height" placeholder="<?php echo $pgp_line_height_placeholder; ?>" onblur="default_value_photo_gallery_plus('#ux_txt_thumbnail_title_line_height', '1.7em')" onfocus="paste_prevent_photo_gallery_plus(this.id);" value="<?php echo isset($manage_thumbnail_data["thumbnail_layout_thumbnail_title_line_height"]) ? esc_attr($manage_thumbnail_data["thumbnail_layout_thumbnail_title_line_height"]) : "1.7em"; ?>">
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="row">
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <div class="input-icon right">
                                             <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_title_margin_text[]" id="ux_txt_title_margin_top" placeholder="<?php echo $pgp_top; ?>" onblur="default_value_photo_gallery_plus('#ux_txt_title_margin_top', 0);" maxlength="3" onkeypress="only_digits_photo_gallery_plus(event);" onfocus="paste_prevent_photo_gallery_plus(this.id);" value="<?php echo intval($thumbnail_layout_thumbnail_title_margin[0]); ?>">
                                             <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_title_margin_text[]" id="ux_txt_title_margin_right" placeholder="<?php echo $pgp_right; ?>" onblur="default_value_photo_gallery_plus('#ux_txt_title_margin_right', 5);" maxlength="3" onkeypress="only_digits_photo_gallery_plus(event);" onfocus="paste_prevent_photo_gallery_plus(this.id);" value="<?php echo intval($thumbnail_layout_thumbnail_title_margin[1]); ?>">
                                             <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_title_margin_text[]" id="ux_txt_title_margin_bottom" placeholder="<?php echo $pgp_bottom; ?>" onblur="default_value_photo_gallery_plus('#ux_txt_title_margin_bottom', 0);" maxlength="3" onkeypress="only_digits_photo_gallery_plus(event);" onfocus="paste_prevent_photo_gallery_plus(this.id);" value="<?php echo intval($thumbnail_layout_thumbnail_title_margin[2]); ?>">
                                             <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_title_margin_text[]" id="ux_txt_title_margin_left" placeholder="<?php echo $pgp_left; ?>" onblur="default_value_photo_gallery_plus('#ux_txt_title_margin_left', 5);" maxlength="3" onkeypress="only_digits_photo_gallery_plus(event);" onfocus="paste_prevent_photo_gallery_plus(this.id);" value="<?php echo intval($thumbnail_layout_thumbnail_title_margin[3]); ?>">
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <div class="input-icon right">
                                             <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_title_padding_text[]" id="ux_txt_title_padding_top" placeholder="<?php echo $pgp_top; ?>" onblur="default_value_photo_gallery_plus('#ux_txt_title_padding_top', 10);" maxlength="3" onkeypress="only_digits_photo_gallery_plus(event);" onfocus="paste_prevent_photo_gallery_plus(this.id);" value="<?php echo intval($thumbnail_layout_thumbnail_title_padding[0]); ?>">
                                             <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_title_padding_text[]" id="ux_txt_title_padding_right" placeholder="<?php echo $pgp_right; ?>" onblur="default_value_photo_gallery_plus('#ux_txt_title_padding_right', 10);" maxlength="3" onkeypress="only_digits_photo_gallery_plus(event);" onfocus="paste_prevent_photo_gallery_plus(this.id);" value="<?php echo intval($thumbnail_layout_thumbnail_title_padding[1]); ?>">
                                             <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_title_padding_text[]" id="ux_txt_title_padding_bottom" placeholder="<?php echo $pgp_bottom; ?>" onblur="default_value_photo_gallery_plus('#ux_txt_title_padding_bottom', 10);" maxlength="3" onkeypress="only_digits_photo_gallery_plus(event);" onfocus="paste_prevent_photo_gallery_plus(this.id);" value="<?php echo intval($thumbnail_layout_thumbnail_title_padding[2]); ?>">
                                 ...
                                 <div class="row">
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <div class="input-icon right">
                                             <input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_description_font_style[]" id="ux_txt_description_font_size" placeholder="<?php echo $pgp_font_size_placeholder; ?>" onblur="default_value_photo_gallery_plus('#ux_txt_description_font_size', 12);" maxlength="3" onkeypress="only_digits_photo_gallery_plus(event);" onfocus="paste_prevent_photo_gallery_plus(this.id);" value="<?php echo intval($thumbnail_layout_thumbnail_description_font_style[0]); ?>">
                                             <input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_description_font_style[]" id="ux_txt_description_font_color" onblur="default_value_photo_gallery_plus('#ux_txt_description_font_color', '#787D85');" onfocus="color_picker_photo_gallery_plus(this, this.value)" placeholder="<?php echo $pgp_color_placeholder; ?>" value="<?php echo esc_attr($thumbnail_layout_thumbnail_description_font_style[1]); ?>">
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-md-6">
