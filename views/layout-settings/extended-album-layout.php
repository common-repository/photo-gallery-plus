...
if (!is_user_logged_in()) {
   ...
   if (!$access_granted) {
      ...
      $extended_album_layout_cover_padding = isset($extended_album_layout_data["extended_album_layout_cover_padding"]) ? explode(",", esc_attr($extended_album_layout_data["extended_album_layout_cover_padding"])) : array(0, 0, 0, 0);
      ...
      if (isset($extended_album_layout_data["extended_album_layout_cover_background_color_transparency"]) && $extended_album_layout_data["extended_album_layout_cover_background_color_transparency"] != "") {
         ...
         $extended_album_layout_cover_background_color_transparency = isset($extended_album_layout_data["extended_album_layout_cover_background_color_transparency"]) ? explode(",", esc_attr($extended_album_layout_data["extended_album_layout_cover_background_color_transparency"])) : array("#ebe8eb", 50);
      }
      ...
      $extended_album_layout_gallery_description_padding = isset($extended_album_layout_data["extended_album_layout_gallery_description_padding"]) ? explode(",", esc_attr($extended_album_layout_data["extended_album_layout_gallery_description_padding"])) : array(5, 10, 10, 5);
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <div class="input-icon right">
                                             <input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_background_color_transperancy[]" id="ux_txt_background_color" placeholder="<?php echo $pgp_background_color; ?>" onfocus="color_picker_photo_gallery_plus(this, this.value)" value="<?php echo esc_attr($extended_album_layout_cover_background_color_transparency[0]); ?>">
                                             <input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_background_color_transperancy[]" id="ux_txt_background_transperancy" maxlength="3" placeholder="<?php echo $pgp_background_transparency; ?>"  onblur="default_value_photo_gallery_plus('#ux_txt_background_transperancy', 50);" onkeypress="only_digits_photo_gallery_plus(event);" onfocus="paste_prevent_photo_gallery_plus(this.id);" onchange="check_opacity_photo_gallery_plus(this);" value="<?php echo intval($extended_album_layout_cover_background_color_transparency[1]); ?>">
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <div class="input-icon right">
                                             <input type="text" class="form-control" name="ux_txt_border_radius" id="ux_txt_border_radius" placeholder="<?php echo $pgp_border_radius_placeholder; ?>" maxlength="3" onkeypress="only_digits_photo_gallery_plus(event);" onblur="default_value_photo_gallery_plus('#ux_txt_border_radius', 0)" onfocus="paste_prevent_photo_gallery_plus(this.id);" value="<?php echo isset($extended_album_layout_data["extended_album_layout_cover_border_radius"]) ? intval($extended_album_layout_data["extended_album_layout_cover_border_radius"]) : 0; ?>">
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <div class="input-icon right">
                                             <input type="text" class="form-control" name="ux_txt_transition_time" id="ux_txt_transition_time" placeholder="<?php echo $pgp_transition_time_placeholder; ?>" onblur="default_value_photo_gallery_plus('#ux_txt_transition_time', 1)" maxlength="1" onkeypress="digits_with_dot_photo_gallery_plus(event);" onfocus="paste_prevent_photo_gallery_plus(this.id);" value="<?php echo isset($extended_album_layout_data["extended_album_layout_cover_transition_time"]) ? intval($extended_album_layout_data["extended_album_layout_cover_transition_time"]) : 1; ?>">
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" name="ux_txt_album_title_line_height" id="ux_txt_album_title_line_height" placeholder="<?php echo $pgp_line_height_placeholder; ?>" onblur="default_value_photo_gallery_plus('#ux_txt_album_title_line_height', '1.7em');"  onfocus="paste_prevent_photo_gallery_plus(this.id);" value="<?php echo isset($extended_album_layout_data["extended_album_layout_title_line_height"]) ? esc_attr($extended_album_layout_data["extended_album_layout_title_line_height"]) : "1.7em"; ?>">
                                       </div>
                                    </div>
                                 </div>
                                 <div class="form-group">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" name="ux_txt_album_description_line_height" id="ux_txt_album_description_line_height" placeholder="<?php echo $pgp_line_height_placeholder; ?>" onblur="default_value_photo_gallery_plus('#ux_txt_album_description_line_height', '1.7em');"  onfocus="paste_prevent_photo_gallery_plus(this.id);" value="<?php echo isset($extended_album_layout_data["extended_album_layout_description_line_height"]) ? esc_attr($extended_album_layout_data["extended_album_layout_description_line_height"]) : "1.7em"; ?>">
                                       </div>
                                    </div>
                                 </div>
                                 <div class="form-group">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" name="ux_txt_gallery_title_line_height" id="ux_txt_gallery_title_line_height" placeholder="<?php echo $pgp_line_height_placeholder; ?>" onblur="default_value_photo_gallery_plus('#ux_txt_gallery_title_line_height', '1.7em');"  onfocus="paste_prevent_photo_gallery_plus(this.id);" value="<?php echo isset($extended_album_layout_data["extended_album_layout_gallery_title_line_height"]) ? esc_attr($extended_album_layout_data["extended_album_layout_gallery_title_line_height"]) : "1.7em"; ?>">
                                       </div>
                                    </div>
                                 </div>
                                 <div class="form-group">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" name="ux_txt_gallery_description_line_height" id="ux_txt_gallery_description_line_height" placeholder="<?php echo $pgp_line_height_placeholder; ?>" onblur="default_value_photo_gallery_plus('#ux_txt_gallery_description_line_height', '1.7em');"  onfocus="paste_prevent_photo_gallery_plus(this.id);" value="<?php echo isset($extended_album_layout_data["extended_album_layout_gallery_description_line_height"]) ? esc_attr($extended_album_layout_data["extended_album_layout_gallery_description_line_height"]) : "1.7em"; ?>">
                                       </div>
                                    </div>
                                 </div>
                                 <div class="form-group">
                                 ...
                                 <div class="row">
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" id="ux_txt_extended_album_button_text" name="ux_txt_extended_album_button_text" placeholder="<?php echo $pgp_button_text_placeholder; ?>" onblur="default_value_photo_gallery_plus('#ux_txt_extended_album_button_text', 'Back To Album');"  value="<?php echo isset($extended_album_layout_data["extended_album_layout_button_text"]) ? esc_attr($extended_album_layout_data["extended_album_layout_button_text"]) : 'Back To Album'; ?>">
                                       </div>
                                    </div>
                                    <div class="col-md-6">
                                       <div class="form-group">
                                 ...
                                 <div class="row">
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" id="ux_txt_extended_album_button_color" name="ux_txt_extended_album_button_color" placeholder="<?php echo $pgp_album_button_color_placeholder; ?>" onblur="default_value_photo_gallery_plus('#ux_txt_extended_album_button_color', '#a4cd39');"  onkeypress="only_digits_photo_gallery_plus(event);" onfocus="color_picker_photo_gallery_plus(this, this.value); paste_prevent_photo_gallery_plus(this.id);" value="<?php echo isset($extended_album_layout_data["extended_album_layout_button_color"]) ? esc_attr($extended_album_layout_data["extended_album_layout_button_color"]) : '#a4cd39'; ?>">
                                       </div>
                                    </div>
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" id="ux_txt_extended_album_button_hover_color" name="ux_txt_extended_album_button_hover_color" placeholder="<?php echo $pgp_album_button_hover_color_placeholder; ?>" onblur="default_value_photo_gallery_plus('#ux_txt_extended_album_button_hover_color', '#a4cd39');"  onkeypress="only_digits_photo_gallery_plus(event);" onfocus="color_picker_photo_gallery_plus(this, this.value); paste_prevent_photo_gallery_plus(this.id);" value="<?php echo isset($extended_album_layout_data["extended_album_layout_button_hover_color"]) ? esc_attr($extended_album_layout_data["extended_album_layout_button_hover_color"]) : '#a4cd39'; ?>">
                                       </div>
                                    </div>
                                 </div>
                                 <div class="row">
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <div class="input-icon right">
                                             <input type="text" class="form-control input-width-25 input-inline" name="ux_txt_extended_album_button_border_style[]" id="ux_txt_extended_album_button_border_size" placeholder="<?php echo $pgp_width_placeholder; ?>" onblur="default_value_photo_gallery_plus('#ux_txt_extended_album_button_border_size', 0);" maxlength="3" onkeypress="only_digits_photo_gallery_plus(event);" onfocus="paste_prevent_photo_gallery_plus(this.id);" value="<?php echo intval($extended_album_layout_button_border_style[0]); ?>">
                                             ...
                                             <input type="text" class="form-control input-normal input-inline" name="ux_txt_extended_album_button_border_style[]" id="ux_txt_extended_album_button_border_color" onblur="default_value_photo_gallery_plus('#ux_txt_extended_album_button_border_color', '#a4cd39');" onfocus="color_picker_photo_gallery_plus(this, this.value)" placeholder="<?php echo $pgp_color_placeholder; ?>" value="<?php echo esc_attr($extended_album_layout_button_border_style[2]); ?>">
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <div class="input-icon right">
                                             <input type="text" class="form-control" name="ux_txt_extended_album_button_border_hover" id="ux_txt_extended_album_button_border_hover" onfocus="color_picker_photo_gallery_plus(this, this.value)" placeholder="<?php echo $pgp_button_border_hover_placeholder; ?>"  onkeypress="only_digits_photo_gallery_plus(event);" onblur="default_value_photo_gallery_plus('#ux_txt_extended_album_button_border_hover', '#a4cd39');" onfocus="paste_prevent_photo_gallery_plus(this.id);" value="<?php echo isset($extended_album_layout_data["extended_album_layout_button_border_hover_color"]) ? esc_attr($extended_album_layout_data["extended_album_layout_button_border_hover_color"]) : '#a4cd39'; ?>">
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                                 <div class="row">
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <div class="input-icon right">
                                             <input type="text" class="form-control" name="ux_txt_extended_album_button_border_radius" id="ux_txt_extended_album_button_border_radius" placeholder="<?php echo $pgp_border_radius_placeholder; ?>" maxlength="3" onkeypress="only_digits_photo_gallery_plus(event);" onblur="default_value_photo_gallery_plus('#ux_txt_extended_album_button_border_radius', 4)" onfocus="paste_prevent_photo_gallery_plus(this.id);" value="<?php echo isset($extended_album_layout_data["extended_album_layout_button_border_radius"]) ? intval($extended_album_layout_data["extended_album_layout_button_border_radius"]) : 4; ?>">
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-md-6">
                                 ...
                                 <div class="row">
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <div class="input-icon right">
                                             <input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_extended_album_button_font_style[]" id="ux_txt_extended_album_button_font_size" placeholder="<?php echo $pgp_font_size_placeholder; ?>" onblur="default_value_photo_gallery_plus('#ux_txt_extended_album_button_font_size', 14);" maxlength="3" onkeypress="only_digits_photo_gallery_plus(event);" onfocus="paste_prevent_photo_gallery_plus(this.id);" value="<?php echo intval($extended_album_layout_button_font_style[0]); ?>">
                                             <input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_extended_album_button_font_style[]" id="ux_txt_extended_album_button_font_color" onblur="default_value_photo_gallery_plus('#ux_txt_extended_album_button_font_color', '#ffffff');" onfocus="color_picker_photo_gallery_plus(this, this.value)" placeholder="<?php echo $pgp_color_placeholder; ?>" value="<?php echo esc_attr($extended_album_layout_button_font_style[1]); ?>">
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" id="ux_txt_extended_album_button_font_hover_color" name="ux_txt_extended_album_button_font_hover_color" onfocus="color_picker_photo_gallery_plus(this, this.value)" placeholder="<?php echo $pgp_button_font_hover_placeholder; ?>" onblur="default_value_photo_gallery_plus('#ux_txt_extended_album_button_font_hover_color', '#ffffff');"  onkeypress="only_digits_photo_gallery_plus(event);" onfocus="paste_prevent_photo_gallery_plus(this.id);" value="<?php echo isset($extended_album_layout_data["extended_album_layout_button_font_hover_color"]) ? esc_attr($extended_album_layout_data["extended_album_layout_button_font_hover_color"]) : '#ffffff'; ?>">
                                       </div>
                                    </div>
                                 </div>
                                 <div class="row">
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <div class="input-icon right">
                                             <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_extended_album_button_margin_text[]" id="ux_txt_extended_album_button_margin_top" placeholder="<?php echo $pgp_top; ?>" onblur="default_value_photo_gallery_plus('#ux_txt_extended_album_button_margin_top', 10);" maxlength="3" onkeypress="only_digits_photo_gallery_plus(event);" onfocus="paste_prevent_photo_gallery_plus(this.id);" value="<?php echo intval($extended_album_layout_button_margin[0]); ?>">
                                             <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_extended_album_button_margin_text[]" id="ux_txt_extended_album_button_margin_right" placeholder="<?php echo $pgp_right; ?>" onblur="default_value_photo_gallery_plus('#ux_txt_extended_album_button_margin_right', 0);" maxlength="3" onkeypress="only_digits_photo_gallery_plus(event);" onfocus="paste_prevent_photo_gallery_plus(this.id);" value="<?php echo intval($extended_album_layout_button_margin[1]); ?>">
                                             <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_extended_album_button_margin_text[]" id="ux_txt_extended_album_button_margin_bottom" placeholder="<?php echo $pgp_bottom; ?>" onblur="default_value_photo_gallery_plus('#ux_txt_extended_album_button_margin_bottom', 0);" maxlength="3" onkeypress="only_digits_photo_gallery_plus(event);" onfocus="paste_prevent_photo_gallery_plus(this.id);" value="<?php echo intval($extended_album_layout_button_margin[2]); ?>">
                                             <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_extended_album_button_margin_text[]" id="ux_txt_extended_album_button_margin_left" placeholder="<?php echo $pgp_left; ?>" onblur="default_value_photo_gallery_plus('#ux_txt_extended_album_button_margin_left', 0);" maxlength="3" onkeypress="only_digits_photo_gallery_plus(event);" onfocus="paste_prevent_photo_gallery_plus(this.id);" value="<?php echo intval($extended_album_layout_button_margin[3]); ?>">
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <div class="input-icon right">
                                             <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_extended_album_button_padding_text[]" id="ux_txt_extended_album_button_padding_top" placeholder="<?php echo $pgp_top; ?>" onblur="default_value_photo_gallery_plus('#ux_txt_extended_album_button_padding_top', 8);" maxlength="3" onkeypress="only_digits_photo_gallery_plus(event);" onfocus="paste_prevent_photo_gallery_plus(this.id);" value="<?php echo intval($extended_album_layout_button_padding [0]); ?>">
                                             <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_extended_album_button_padding_text[]" id="ux_txt_extended_album_button_padding_right" placeholder="<?php echo $pgp_right; ?>" onblur="default_value_photo_gallery_plus('#ux_txt_extended_album_button_padding_right', 12);" maxlength="3" onkeypress="only_digits_photo_gallery_plus(event);" onfocus="paste_prevent_photo_gallery_plus(this.id);" value="<?php echo intval($extended_album_layout_button_padding [1]); ?>">
                                             <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_extended_album_button_padding_text[]" id="ux_txt_extended_album_button_padding_bottom" placeholder="<?php echo $pgp_bottom; ?>" onblur="default_value_photo_gallery_plus('#ux_txt_extended_album_button_padding_bottom', 8);" maxlength="3" onkeypress="only_digits_photo_gallery_plus(event);" onfocus="paste_prevent_photo_gallery_plus(this.id);" value="<?php echo intval($extended_album_layout_button_padding [2]); ?>">
                                             <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_extended_album_button_padding_text[]" id="ux_txt_extended_album_button_padding_left" placeholder="<?php echo $pgp_left; ?>" onblur="default_value_photo_gallery_plus('#ux_txt_extended_album_button_padding_left', 12);" maxlength="3" onkeypress="only_digits_photo_gallery_plus(event);" onfocus="paste_prevent_photo_gallery_plus(this.id);" value="<?php echo intval($extended_album_layout_button_padding [3]); ?>">
                                          </div>
                                       </div>
                                    </div>
                                 </div>
