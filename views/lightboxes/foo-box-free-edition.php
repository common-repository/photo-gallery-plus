                              ...
                              <div class="tab-pane active" id="settings">
                                 <div class="row">
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          <label class="control-label">
                                             <?php echo $pgp_foo_box_free_edition_show_count_title; ?> :
                                             <i class="icon-custom-question tooltips" data-original-title="<?php echo $pgp_foo_box_free_edition_show_count_tooltip; ?>" data-placement="right"></i>
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          <label class="control-label">
                                             <?php echo $pgp_foo_box_hide_page_scrollbars_title; ?> :
                                             <i class="icon-custom-question tooltips" data-original-title="<?php echo $pgp_foo_box_hide_page_scrollbars_tooltip; ?>" data-placement="right"></i>
                                             <span class="required" aria-required="true">* ( <?php echo $pgp_premium_edition; ?> ) </span>
                                          </label>
                                 ...
                                 <div class="row">
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          <label class="control-label">
                                             <?php echo $pgp_foo_box_caption_show_on_hover_title; ?> :
                                             <i class="icon-custom-question tooltips" data-original-title="<?php echo $pgp_foo_box_caption_show_on_hover_tooltip; ?>" data-placement="right"></i>
                                             <span class="required" aria-required="true">* ( <?php echo $pgp_premium_edition; ?> ) </span>
                                          </label>
                                          <div class="input-icon right">
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          <label class="control-label">
                                             <?php echo $pgp_foo_box_close_overlay_click_title; ?> :
                                             <i class="icon-custom-question tooltips" data-original-title="<?php echo $pgp_foo_box_close_overlay_click_tooltip; ?>" data-placement="right"></i>
                                             <span class="required" aria-required="true">* ( <?php echo $pgp_premium_edition; ?> ) </span>
                                          </label>
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" name="ux_txt_overlay_opacity" id="ux_txt_overlay_opacity" maxlength="3" onkeypress="only_digits_photo_gallery_plus(event);" placeholder="<?php echo $pgp_lightbox_overlay_opacity_placeholder; ?>" onblur="default_value_photo_gallery_plus('#ux_txt_overlay_opacity', 75);" onfocus="paste_prevent_photo_gallery_plus(this.id);" value="<?php echo isset($foo_box["foo_box_overlay_opacity"]) ? intval($foo_box["foo_box_overlay_opacity"]) : 75; ?>">
                                       </div>
                                    </div>
                                 </div>
                                 <div class="row">
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <div class="input-icon right">
                                             <input type="text" class="form-control" name="ux_txt_border_radius" id="ux_txt_border_radius" placeholder="<?php echo $pgp_border_radius_placeholder; ?>" maxlength="3" onkeypress="only_digits_photo_gallery_plus(event);" onblur="default_value_photo_gallery_plus('#ux_txt_border_radius', 5)" onfocus="paste_prevent_photo_gallery_plus(this.id);" value="<?php echo isset($foo_box["foo_box_border_radius"]) ? intval($foo_box["foo_box_border_radius"]) : 10; ?>">
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="row">
                                    <div class="col-md-12">
                                       <div class="form-group">
                                          ...
                                          <div class="input-icon right">
                                             <select id="ux_ddl_foo_box_title" name="ux_ddl_foo_box_title" class="form-control" onchange="show_hide_control_photo_gallery_plus('ux_ddl_foo_box_title', 'foo_box_title_div');">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-12">
                                       <div class="form-group">
                                          ...
                                          <div class="input-icon right">
                                             <select id="ux_ddl_foo_box_description" name="ux_ddl_foo_box_description" class="form-control" onchange="show_hide_control_photo_gallery_plus('ux_ddl_foo_box_description', 'foo_box_description_div');">
                                                <option value="true"><?php echo $pgp_show; ?></option>
                                                <option value="false"><?php echo $pgp_hide; ?></option>
                                             </select>
                                          </div>
