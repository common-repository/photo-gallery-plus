<?php
/**
 * Template to view and generate Shortcode for Image Browser Layout Shortcode.
 *
 * @author 	The WP Geeks
...
if (!is_user_logged_in()) {
   ...
   if (!$access_granted) {
      return;
   } else if (shortcode_generator_photo_gallery_plus == "1") {
         ...
         <div class="col-md-12">
            <div class="portlet box vivid-green">
               ...
               <div class="portlet-body form">
                  <form id="ux_frm_image_browser_layout">
                     <div class="form-body">
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <select id="ux_ddl_choose_type" name="ux_ddl_choose_type" class="form-control" onchange="shortcode_source_type_control_photo_gallery_plus('ux_ddl_choose_type', 'ux_div_gallery', 'ux_div_album', 'ux_div_album_control'); generate_shortcode_image_browser_layout_photo_gallery_plus();">
                           ...
                           <div class="col-md-6">
                              <div class="form-group" id="ux_div_gallery">
                                 ...
                                 <select id="ux_ddl_choose_gallery" name="ux_ddl_choose_gallery" class="form-control" onchange="generate_shortcode_image_browser_layout_photo_gallery_plus();">
                                    <option value=""><?php echo $pgp_choose_gallery_title; ?></option>
                                    <?php
                                    foreach ($image_browser_layout_shortcode as $value) {
                                       ?>
                              ...
                              <div class="form-group"  id="ux_div_album">
                                 ...
                                 <select id="ux_ddl_choose_album" name="ux_ddl_choose_album" class="form-control" onchange="generate_shortcode_image_browser_layout_photo_gallery_plus();">
                                    <option value=""><?php echo $pgp_choose_album_title; ?></option>
                                    <?php
                                    foreach ($image_browser_layout_get_album_data as $value) {
                                       ?>
                        ...
                        <div class="form-group" id="ux_div_album_type">
                           ...
                           <select id="ux_ddl_choose_album_type" name="ux_ddl_choose_album_type" class="form-control" onchange="generate_shortcode_image_browser_layout_photo_gallery_plus();">
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <div class="input-icon right">
                                    <select name="ux_ddl_alignment" id="ux_ddl_alignment" class="form-control" onchange="generate_shortcode_image_browser_layout_photo_gallery_plus();">
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label class="control-label">
                                    <?php echo $pgp_image_browser_layout_image_browser_title; ?> :
                                    <i class="icon-custom-question tooltips" data-original-title="<?php echo $pgp_image_browser_layout_image_browser_tooltip; ?>" data-placement="right"></i>
                                    <span class="required" aria-required="true">* <?php echo " ( " . $pgp_premium_label . " ) "; ?></span>
                                 </label>
                                 <div class= "input-icon right">
                                    <input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_width" id="ux_txt_width" value="800" maxlength="4" onkeypress="only_digits_photo_gallery_plus(event);" onfocus="paste_prevent_photo_gallery_plus(this.id);" onblur="set_thumbnail_dimension_in_shortcode_photo_gallery_plus(this,<?php echo $image_dimensions[0] ?>, '<?php echo $pgp_shortcode_image_dimensions_exceed_msg; ?>'); generate_shortcode_image_browser_layout_photo_gallery_plus();" placeholder="<?php echo $pgp_max_width_placeholder; ?>">
                                    <input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_height" id="ux_txt_height" value="500" maxlength="4" onkeypress="only_digits_photo_gallery_plus(event);" onfocus="paste_prevent_photo_gallery_plus(this.id);"  onblur="set_thumbnail_dimension_in_shortcode_photo_gallery_plus(this,<?php echo $image_dimensions[1] ?>, '<?php echo $pgp_shortcode_image_dimensions_exceed_msg; ?>'); generate_shortcode_image_browser_layout_photo_gallery_plus();" placeholder="<?php echo $pgp_max_height_placeholder; ?>">
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div class="form-group">
                           ...
                           <select name="ux_ddl_button_text" id="ux_ddl_button_text" class="form-control" onchange="generate_shortcode_image_browser_layout_photo_gallery_plus();">
                        ...
                        <div class="row" id="ux_div_album_control">
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <select id="ux_ddl_album_title" name="ux_ddl_album_title" class="form-control" onchange="generate_shortcode_image_browser_layout_photo_gallery_plus();">
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <select id="ux_ddl_album_description" name="ux_ddl_album_description" class="form-control" onchange="generate_shortcode_image_browser_layout_photo_gallery_plus();">
                                    <option value="show"><?php echo $pgp_show; ?></option>
                                    <option value="hide"><?php echo $pgp_hide; ?></option>
                                 </select>
                              </div>
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <select id="ux_ddl_gallery_title" name="ux_ddl_gallery_title" class="form-control" onchange="generate_shortcode_image_browser_layout_photo_gallery_plus();">
                                    <option value="show"><?php echo $pgp_show; ?></option>
                                    <option value="hide"><?php echo $pgp_hide; ?></option>
                                 </select>
                              </div>
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <div class="input-icon right">
                                    <select name="ux_ddl_gallery_description" id="ux_ddl_gallery_description" class="form-control" onchange="generate_shortcode_image_browser_layout_photo_gallery_plus();">
                                       <option value="show"><?php echo $pgp_show; ?></option>
                                       <option value="hide"><?php echo $pgp_hide; ?></option>
                                    </select>
                                 </div>
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <select id="ux_ddl_thumbnail_title" name="ux_ddl_thumbnail_title" class="form-control" onchange="generate_shortcode_image_browser_layout_photo_gallery_plus();">
                                    <option value="show"><?php echo $pgp_show; ?></option>
                                    <option value="hide"><?php echo $pgp_hide; ?></option>
                                 </select>
                              </div>
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <div class="input-icon right">
                                    <select name="ux_ddl_thumbnail_description" id="ux_ddl_thumbnail_description" class="form-control" onchange="generate_shortcode_image_browser_layout_photo_gallery_plus();">
                                       <option value="show"><?php echo $pgp_show; ?></option>
                                       <option value="hide"><?php echo $pgp_hide; ?></option>
                                    </select>
                                 </div>
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <select name="ux_ddl_sort_image_by" id="ux_ddl_sort_image_by" class="form-control" onchange="generate_shortcode_image_browser_layout_photo_gallery_plus();">
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <select name="ux_ddl_order_images" id="ux_ddl_order_images" class="form-control" onchange="generate_shortcode_image_browser_layout_photo_gallery_plus();">
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <div class="input-icon right">
                                    <select name="ux_ddl_lazy_load" id="ux_ddl_lazy_load" class="form-control" onchange="generate_shortcode_image_browser_layout_photo_gallery_plus();">
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <div class="input-icon right">
                                    <select name="ux_ddl_filters" id="ux_ddl_filters" class="form-control" onchange="generate_shortcode_image_browser_layout_photo_gallery_plus();">
                                       <option value="disable"><?php echo $pgp_disable; ?></option>
                                       <option value="enable"><?php echo $pgp_enable; ?></option>
                                    </select>
                                 </div>
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <div class="input-icon right">
                                    <select name="ux_ddl_order_by" id="ux_ddl_order_by" class="form-control" onchange="generate_shortcode_image_browser_layout_photo_gallery_plus();">
                                       <option value="disable"><?php echo $pgp_disable; ?></option>
                                       <option value="enable"><?php echo $pgp_enable; ?></option>
                                    </select>
                                 </div>
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <div class="input-icon right">
                                    <select name="ux_ddl_search_box" id="ux_ddl_search_box" class="form-control" onchange="generate_shortcode_image_browser_layout_photo_gallery_plus();">
                                       <option value="disable"><?php echo $pgp_disable; ?></option>
                                       <option value="enable"><?php echo $pgp_enable; ?></option>
                                    </select>
                                 </div>
                           ...
                           <div class="row">
                              <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <select id="ux_ddl_animation_effect" name="ux_ddl_animation_effect" class="form-control" onchange="generate_shortcode_image_browser_layout_photo_gallery_plus();">
                              ...
                              <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <div class="input-icon right">
                                       <select id="ux_ddl_special_effects" name="ux_ddl_special_effects" class="form-control" onchange="generate_shortcode_image_browser_layout_photo_gallery_plus();">
                                          <option value="none"><?php echo $pgp_none; ?></option>
