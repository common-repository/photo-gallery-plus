                  ...
                  <form id="ux_frm_blog_style_layout">
                     <div class="form-body">
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <select id="ux_ddl_choose_type" name="ux_ddl_choose_type" class="form-control" onchange="shortcode_source_type_control_photo_gallery_plus('ux_ddl_choose_type', 'ux_div_gallery', 'ux_div_album', 'ux_div_show_hide_album'); generate_shortcode_blog_style_layout_photo_gallery_plus();">
                           ...
                           <div class="col-md-6">
                              <div class="form-group" id="ux_div_gallery">
                                 ...
                                 <select id="ux_ddl_choose_gallery" name="ux_ddl_choose_gallery" class="form-control" onchange="generate_shortcode_blog_style_layout_photo_gallery_plus();">
                              ...
                              <div class="form-group" id="ux_div_album">
                                 ...
                                 <select id="ux_ddl_choose_album" name="ux_ddl_choose_album" class="form-control" onchange="generate_shortcode_blog_style_layout_photo_gallery_plus();">
                        ...
                        <div class="form-group" id="ux_div_album_type">
                           ...
                           <select id="ux_ddl_choose_album_type" name="ux_ddl_choose_album_type" class="form-control" onchange="generate_shortcode_blog_style_layout_photo_gallery_plus();">
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <div class="input-icon right">
                                    <select name="ux_ddl_alignment" id="ux_ddl_alignment" class="form-control" onchange="generate_shortcode_blog_style_layout_photo_gallery_plus();">
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label class="control-label">
                                    <?php echo $pgp_blog_style_layout_blog_width_title; ?> :
                                    <i class="icon-custom-question tooltips" data-original-title="<?php echo $pgp_blog_style_layout_blog_width_tooltip; ?>" data-placement="right"></i>
                                    <span class="required" aria-required="true">* <?php echo " ( " . $pgp_premium_edition . " ) "; ?></span>
                                 </label>
                                 <input type="text" class="form-control" name="ux_txt_blog_style_thumbnail_width" id="ux_txt_blog_style_thumbnail_width" value="500" maxlength="4" onkeypress="only_digits_photo_gallery_plus(event);" onfocus="paste_prevent_photo_gallery_plus(this.id);" onblur="set_thumbnail_dimension_in_shortcode(this,<?php echo $image_dimensions[0] ?>, '<?php echo $pgp_shortcode_blog_width_exceed_msg; ?>'); generate_shortcode_blog_style_layout_photo_gallery_plus();" placeholder="<?php echo $pgp_max_width_placeholder; ?>">
                              </div>
                           </div>
                        </div>
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <select name="ux_ddl_lightbox_type" id="ux_ddl_lightbox_type" class="form-control" onchange="generate_shortcode_blog_style_layout_photo_gallery_plus();">
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <select name="ux_ddl_page_navigation" id="ux_ddl_page_navigation" class="form-control" onchange="show_hide_control_photo_gallery_plus('ux_ddl_page_navigation', 'ux_no_of_images_per_page'); generate_shortcode_blog_style_layout_photo_gallery_plus();">
                           ...
                           <div class="row">
                              <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <select id="ux_ddl_album_title" name="ux_ddl_album_title" class="form-control" onchange="generate_shortcode_blog_style_layout_photo_gallery_plus();">
                              ...
                              <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <select id="ux_ddl_album_description" name="ux_ddl_album_description" class="form-control" onchange="generate_shortcode_blog_style_layout_photo_gallery_plus();">
                                       <option value="show"><?php echo $pgp_show; ?></option>
                                       <option value="hide"><?php echo $pgp_hide; ?></option>
                                    </select>
                                 </div>
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <select id="ux_ddl_gallery_title" name="ux_ddl_gallery_title" class="form-control" onchange="generate_shortcode_blog_style_layout_photo_gallery_plus();">
                                    <option value="show"><?php echo $pgp_show; ?></option>
                                    <option value="hide"><?php echo $pgp_hide; ?></option>
                                 </select>
                              </div>
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <div class="input-icon right">
                                    <select name="ux_ddl_gallery_description" id="ux_ddl_gallery_description" class="form-control" onchange="generate_shortcode_blog_style_layout_photo_gallery_plus();">
                                       <option value="show"><?php echo $pgp_show; ?></option>
                                       <option value="hide"><?php echo $pgp_hide; ?></option>
                                    </select>
                                 </div>
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <select id="ux_ddl_thumbnail_title" name="ux_ddl_thumbnail_title" class="form-control" onchange="generate_shortcode_blog_style_layout_photo_gallery_plus();">
                                    <option value="show"><?php echo $pgp_show; ?></option>
                                    <option value="hide"><?php echo $pgp_hide; ?></option>
                                 </select>
                              </div>
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <div class="input-icon right">
                                    <select name="ux_ddl_thumbnail_description" id="ux_ddl_thumbnail_description" class="form-control" onchange="generate_shortcode_blog_style_layout_photo_gallery_plus();">
                                       <option value="show"><?php echo $pgp_show; ?></option>
                                       <option value="hide"><?php echo $pgp_hide; ?></option>
                                    </select>
                                 </div>
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <select name="ux_ddl_order_images" id="ux_ddl_order_images" class="form-control" onchange="generate_shortcode_blog_style_layout_photo_gallery_plus();">
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <select name="ux_ddl_sort_image_by" id="ux_ddl_sort_image_by" class="form-control" onchange="generate_shortcode_blog_style_layout_photo_gallery_plus();">
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <select name="ux_ddl_lazy_load" id="ux_ddl_lazy_load" class="form-control" onchange="generate_shortcode_blog_style_layout_photo_gallery_plus();">
                                    <option value="disable"><?php echo $pgp_disable; ?></option>
                                    <option value="enable"><?php echo $pgp_enable; ?></option>
                                 </select>
                              </div>
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <select name="ux_ddl_filters" id="ux_ddl_filters" class="form-control" onchange="generate_shortcode_blog_style_layout_photo_gallery_plus();">
                                    <option value="disable"><?php echo $pgp_disable; ?></option>
                                    <option value="enable"><?php echo $pgp_enable; ?></option>
                                 </select>
                              </div>
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <select name="ux_ddl_order_by" id="ux_ddl_order_by" class="form-control" onchange="generate_shortcode_blog_style_layout_photo_gallery_plus();">
                                    <option value="disable"><?php echo $pgp_disable; ?></option>
                                    <option value="enable"><?php echo $pgp_enable; ?></option>
                                 </select>
                              </div>
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <select name="ux_ddl_search_box" id="ux_ddl_search_box" class="form-control"  onchange="generate_shortcode_blog_style_layout_photo_gallery_plus();">
                                    <option value="disable"><?php echo $pgp_disable; ?></option>
                                    <option value="enable"><?php echo $pgp_enable; ?></option>
                                 </select>
                              </div>
                           ...
                           <div class="row">
                              <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <select id="ux_ddl_animation_effect" name="ux_ddl_animation_effect" class="form-control" onchange="generate_shortcode_blog_style_layout_photo_gallery_plus();">
                              ...
                              <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <div class="input-icon right">
                                       <select id="ux_ddl_special_effects" name="ux_ddl_special_effects" class="form-control" onchange="generate_shortcode_blog_style_layout_photo_gallery_plus();">
                                          <option value="none"><?php echo $pgp_none; ?></option>
