                  ...
                  <form id="ux_frm_slide_show_layout">
                     <div class="form-body">
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <select id="ux_ddl_choose_type" name="ux_ddl_choose_type" class="form-control" onchange="shortcode_source_type_control_photo_gallery_plus('ux_ddl_choose_type', 'ux_div_gallery', 'ux_div_album', 'ux_div_album_control'); generate_shortcode_slideshow_layout_photo_gallery_plus();">
                           ...
                           <div class="col-md-6">
                              <div class="form-group" id="ux_div_gallery">
                                 ...
                                 <select id="ux_ddl_choose_gallery" name="ux_ddl_choose_gallery" class="form-control" onchange="generate_shortcode_slideshow_layout_photo_gallery_plus();">
                              ...
                              <div class="form-group" id="ux_div_album">
                                 ...
                                 <select id="ux_ddl_choose_album" name="ux_ddl_choose_album" class="form-control" onchange="generate_shortcode_slideshow_layout_photo_gallery_plus();">
                        ...
                        <div class="form-group" id="ux_div_album_type">
                           ...
                           <select id="ux_ddl_choose_album_type" name="ux_ddl_choose_album_type" class="form-control" onchange="generate_shortcode_slideshow_layout_photo_gallery_plus();">
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <div class="input-icon right">
                                    <select name="ux_ddl_alignment" id="ux_ddl_alignment" class="form-control" onchange="generate_shortcode_slideshow_layout_photo_gallery_plus();">
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label class="control-label">
                                    <?php echo $pgp_slideshow_layout_shortcode_slideshow_width ?> :
                                    <i class="icon-custom-question tooltips" data-original-title="<?php echo $pgp_slideshow_layout_shortcode_slideshow_tooltip; ?>" data-placement="right"></i>
                                    <span class="required" aria-required="true">* <?php echo " ( " . $pgp_premium_edition . " ) "; ?></span>
                                 </label>
                                 <div class="input-icon right">
                                    <input type="text" class="form-control input-inline" name="ux_txt_slideshow_width" id="ux_txt_slideshow_width" placeholder="<?php echo $pgp_width_layout_placeholder; ?>" onblur="set_thumbnail_dimension_in_shortcode(this,<?php echo $image_dimensions[0] ?>, '<?php echo $pgp_shortcode_slideshow_width_exceed_msg; ?>'); generate_shortcode_slideshow_layout_photo_gallery_plus();" maxlength="4" onkeypress="digits_with_dot_photo_gallery_plus(event);" onfocus="paste_prevent_photo_gallery_plus(this.id);" value="800">
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div class="form-group">
                           <label class="control-label">
                              <?php echo $pgp_slideshow_layout_slideshow_flimstrips_title; ?> :
                              <i class="icon-custom-question tooltips" data-original-title="<?php echo $pgp_slideshow_layout_slideshow_flimstrips_tooltip; ?>" data-placement="right"></i>
                              <span class="required" aria-required="true">* <?php echo " ( " . $pgp_premium_edition . " ) "; ?></span>
                           </label>
                           <select name="ux_ddl_filmstrips" id="ux_ddl_filmstrips" class="form-control" onchange="generate_shortcode_slideshow_layout_photo_gallery_plus();">
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label class="control-label">
                                    <?php echo $pgp_slideshow_layout_control_button_title; ?> :
                                    <i class="icon-custom-question tooltips" data-original-title="<?php echo $pgp_slideshow_layout_control_button_tooltip; ?>" data-placement="right"></i>
                                    <span class="required" aria-required="true">* <?php echo " ( " . $pgp_premium_edition . " ) "; ?></span>
                                 </label>
                                 <div class="input-icon right">
                                    <select name="ux_ddl_control_button" id="ux_ddl_control_button" class="form-control" onchange="generate_shortcode_slideshow_layout_photo_gallery_plus();">
                                       <option value="show"><?php echo $pgp_show; ?></option>
                                       <option value="hide"><?php echo $pgp_hide; ?></option>
                                    </select>
                                 </div>
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label class="control-label">
                                    <?php echo $pgp_autoplay_title; ?> :
                                    <i class="icon-custom-question tooltips" data-original-title="<?php echo $pgp_autoplay_tooltip; ?>" data-placement="right"></i>
                                    <span class="required" aria-required="true">* <?php echo " ( " . $pgp_premium_edition . " ) "; ?></span>
                                 </label>
                                 <select id="ux_ddl_autoplay" name="ux_ddl_autoplay" class="form-control" onchange="generate_shortcode_slideshow_layout_photo_gallery_plus();">
                                    <option value="yes" selected><?php echo $pgp_yes; ?></option>
                        ...
                        <div id="ux_div_time_interval">
                           <div class="form-group">
                              <label class="control-label">
                                 <?php echo $pgp_time_interval_title; ?> :
                                 <i class="icon-custom-question tooltips" data-original-title="<?php echo $pgp_time_interval_tooltip; ?>" data-placement="right"></i>
                                 <span class="required" aria-required="true">* <?php echo " ( " . $pgp_premium_edition . " ) "; ?></span>
                              </label>
                              <input type="text" class="form-control" name="ux_txt_time_interval" id="ux_txt_time_interval" value="5" maxlength="3" onkeypress="only_digits_photo_gallery_plus(event);" onblur="default_value_photo_gallery_plus('#ux_txt_time_interval', 5); generate_shortcode_slideshow_layout_photo_gallery_plus();" onfocus="paste_prevent_photo_gallery_plus(this.id);" placeholder="<?php echo $pgp_time_interval_placeholder; ?>">
                           </div>
                        </div>
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label class="control-label">
                                    ...
                                    <i class="icon-custom-question tooltips" data-original-title="<?php echo $pgp_album_description_tooltip; ?>" data-placement="right"></i>
                                    <span class="required" aria-required="true">* <?php echo " ( " . $pgp_premium_edition . " ) "; ?></span>
                                 </label>
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <select id="ux_ddl_gallery_title" name="ux_ddl_gallery_title" class="form-control" onchange="generate_shortcode_slideshow_layout_photo_gallery_plus();">
                                    <option value="show"><?php echo $pgp_show; ?></option>
                                    <option value="hide"><?php echo $pgp_hide; ?></option>
                                 </select>
                              </div>
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <div class="input-icon right">
                                    <select name="ux_ddl_gallery_description" id="ux_ddl_gallery_description" class="form-control" onchange="generate_shortcode_slideshow_layout_photo_gallery_plus();">
                                       <option value="show"><?php echo $pgp_show; ?></option>
                                       <option value="hide"><?php echo $pgp_hide; ?></option>
                                    </select>
                                 </div>
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <select id="ux_ddl_thumbnail_title" name="ux_ddl_thumbnail_title" class="form-control" onchange="generate_shortcode_slideshow_layout_photo_gallery_plus();">
                                    <option value="show"><?php echo $pgp_show; ?></option>
                                    <option value="hide"><?php echo $pgp_hide; ?></option>
                                 </select>
                              </div>
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <div class="input-icon right">
                                    <select name="ux_ddl_thumbnail_description" id="ux_ddl_thumbnail_description" class="form-control" onchange="generate_shortcode_slideshow_layout_photo_gallery_plus();">
                                       <option value="show"><?php echo $pgp_show; ?></option>
                                       <option value="hide"><?php echo $pgp_hide; ?></option>
                                    </select>
                                 </div>
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <div class="input-icon right">
                                    <select name="ux_ddl_sort_image_by" id="ux_ddl_sort_image_by" class="form-control" onchange="generate_shortcode_slideshow_layout_photo_gallery_plus();">
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <select name="ux_ddl_order_images" id="ux_ddl_order_images" class="form-control" onchange="generate_shortcode_slideshow_layout_photo_gallery_plus();">
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <div class="input-icon right">
                                    <select name="ux_ddl_lazy_load" id="ux_ddl_lazy_load" class="form-control" onchange="generate_shortcode_slideshow_layout_photo_gallery_plus();">
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <div class="input-icon right">
                                    <select name="ux_ddl_filters" id="ux_ddl_filters" class="form-control" onchange="generate_shortcode_slideshow_layout_photo_gallery_plus();">
                                       <option value="disable"><?php echo $pgp_disable; ?></option>
                                       <option value="enable"><?php echo $pgp_enable; ?></option>
                                    </select>
                                 </div>
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <div class="input-icon right">
                                    <select name="ux_ddl_order_by" id="ux_ddl_order_by" class="form-control" onchange="generate_shortcode_slideshow_layout_photo_gallery_plus();">
                                       <option value="disable"><?php echo $pgp_disable; ?></option>
                                       <option value="enable"><?php echo $pgp_enable; ?></option>
                                    </select>
                                 </div>
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <div class="input-icon right">
                                    <select name="ux_ddl_search_box" id="ux_ddl_search_box" class="form-control" onchange="generate_shortcode_slideshow_layout_photo_gallery_plus();">
                                       <option value="disable"><?php echo $pgp_disable; ?></option>
                                       <option value="enable"><?php echo $pgp_enable; ?></option>
                                    </select>
                                 </div>
                           ...
                           <div class="row">
                              <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <select id="ux_ddl_animation_effect" name="ux_ddl_animation_effect" class="form-control" onchange="generate_shortcode_slideshow_layout_photo_gallery_plus();">
                              ...
                              <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <div class="input-icon right">
                                       <select id="ux_ddl_special_effects" name="ux_ddl_special_effects" class="form-control" onchange="generate_shortcode_slideshow_layout_photo_gallery_plus();">
                                          <option value="none"><?php echo $pgp_none; ?></option>
