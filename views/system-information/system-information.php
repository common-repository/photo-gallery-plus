 ...
 *
 * @author 	The WP Geeks
 * @package 	photo-gallery-plus/views/system-information
 * @version	1.0.0
 */
if (!defined("ABSPATH")) {
   exit;
...
if (!is_user_logged_in()) {
   ...
   if (!$access_granted) {
      return;
   } else if (system_information_photo_gallery_plus == "1") {
      ?>
      <div class="page-bar">
