   ...
   var t, n, a = {
      ...
      animate: function (t, n) {
         ...
         i.each(t, function () {
            ...
            }), l >= o && c <= s ? (i(this).css("visibility", "visible"), i(this).addClass(t), i(this).addClass("pgp_animation_time")) : n.once === !1 && (i(this).css("visibility", "hidden"), i(this).removeClass(t), i(this).removeClass("pgp_animation_time"))
         })
      }
   };
   jQuery.fn.scrolla_pgp = function (t) {
      return t = i.extend({
         mobile: !1,
         once: !1
